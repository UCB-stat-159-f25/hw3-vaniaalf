...
from scipy.signal import butter, filtfilt, iirdesign, zpk2tf
...
def plot_match_time2(time, tevent, timemax, strain_whitenbp, template_match, det, eventname, plottype, pcolor):
    plt.figure(figsize=(10,8))
    plt.subplot(2,1,1)
...
def plot_match_freq(template_fft, datafreq, data_psd, fs, d_eff, det, eventname, plottype, freqs, pcolor):             
